...
$sql="update tblhouses set Vimage3=:vimage where id=:id";
...
<head>
	...
	<title>Online House Rental Portal | Admin Update Image 3</title>
...
<?php
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage3 from tblhouses where tblhouses.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
