...
$sql="update tblhouses set Vimage4=:vimage where id=:id";
...
<head>
	...
	<title>Online House Rental Portal | Admin Update Image 4</title>
...
<?php
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage4 from tblhouses where tblhouses.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
