...
$sql="update tblhouses set Vimage5=:vimage where id=:id";
...
<head>
	...
	<title>Online House Rental Portal | Admin Update Image 5</title>
...
<?php
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage5 from tblhouses where tblhouses.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
