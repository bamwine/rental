...
$sql="update tblhouses set housesTitle=:vehicletitle,housesBrand=:brand,housesOverview=:vehicleoverview,PricePerDay=:priceperday,bond=:bond,ModelYear=:modelyear,SeatingCapacity=:seatingcapacity,AirConditioner=:airconditioner,PowerDoorLocks=:powerdoorlocks,AntiLockBrakingSystem=:antilockbrakingsys,BrakeAssist=:brakeassist,PowerSteering=:powersteering,DriverAirbag=:driverairbag,PassengerAirbag=:passengerairbag,PowerWindows=:powerwindow,CDPlayer=:cdplayer,CentralLocking=:centrallocking,CrashSensor=:crashcensor,LeatherSeats=:leatherseats where id=:id ";
$query = $dbh->prepare($sql);
$query->bindParam(':vehicletitle',$vehicletitle,PDO::PARAM_STR);
$query->bindParam(':brand',$brand,PDO::PARAM_STR);
$query->bindParam(':vehicleoverview',$vehicleoverview,PDO::PARAM_STR);
$query->bindParam(':priceperday',$priceperday,PDO::PARAM_STR);
$query->bindParam(':bond',$bond,PDO::PARAM_STR);
...
<head>
	...
	<title>Online House Rental Portal | Admin Edit Vehicle Info</title>
...
<?php
$id=intval($_GET['id']);
$sql ="SELECT tblhouses.*,tblbrands.BrandName,tblbrands.id as bid from tblhouses join tblbrands on tblbrands.id=tblhouses.housesBrand where tblhouses.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->housesTitle)?>" required>
</div>
...
<div class="col-sm-10">
<textarea class="form-control" name="vehicalorcview" rows="3" required><?php echo htmlentities($result->housesOverview);?></textarea>
</div>
</div>
...
<div class="col-sm-4">
<select class="selectpicker" name="bond" required>
<option value="<?php echo htmlentities($results->bond);?>"> <?php echo htmlentities($result->bond);?> </option>
...
<label for="inlineCheckbox3"> AntiLock Alarm  System </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Water Heater  </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Fire Sensor </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
