...
<title>Online Rental | House Details</title>
<!--Bootstrap -->
...
$sql = "SELECT tblhouses.*,tblbrands.BrandName,tblbrands.id as bid  from tblhouses join tblbrands on tblbrands.id=tblhouses.housesBrand where tblhouses.id=:vhid";
$query = $dbh -> prepare($sql);
$query->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query->execute();
...
<section class="listing-detail">
  <div class="container">
    <div class="listing_detail_head row">
      <div class="col-md-9">
        <h2><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->housesTitle);?></h2>
      </div>
      <div class="col-md-3">
        ...
        <div class="main_features">
          <ul>
            ...
            <li> <i class="fa fa-cogs" aria-hidden="true"></i>
              <h5><?php echo htmlentities($result->bond);?></h5>
              <p> Type</p>
            </li>
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap">
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">House Overview </a></li>
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane active" id="vehicle-overview">
                ...
                <p><?php echo htmlentities($result->housesOverview);?></p>
              </div>
...
<tr>
<td>AntiLock Alarm System (AAS)</td>
...
<?php
$bid=$_SESSION['brndid'];
$sql="SELECT tblhouses.housesTitle,tblbrands.BrandName,tblhouses.PricePerDay,tblhouses.bond,tblhouses.ModelYear,tblhouses.id,tblhouses.SeatingCapacity,tblhouses.housesOverview,tblhouses.Vimage1 from tblhouses join tblbrands on tblbrands.id=tblhouses.housesBrand where tblhouses.housesBrand=:bid";
$query = $dbh -> prepare($sql);
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              <h5><a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->housesTitle);?></a></h5>
              <p class="list-price">$<?php echo htmlentities($result->PricePerDay);?></p>

              <ul class="features_list">

             <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> bedrooms</li>
                <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> model</li>
                <li><i class="fa fa-home" aria-hidden="true"></i><?php echo htmlentities($result->bond);?></li>
              </ul>
            </div>
          </div>
        </div>
